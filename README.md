...
![downloads-badge](https://img.shields.io/github/downloads/GenomiqueENS/AsaruSim/total)
...
- Nextflow >= 24.04.4 : A workflow engine for complex data pipelines. [Installation guide for Nextflow](https://www.nextflow.io/docs/latest/getstarted.html).
